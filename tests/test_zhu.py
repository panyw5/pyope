...
def test_zhu_star_product_matches_weight_one_current_formula():
    ...
    J = BasisOperator("J_zhu_star", conformal_weight=1)
    K = BasisOperator("K_zhu_star", conformal_weight=1)
    Bosonic(J, K)
...
def test_zhu_circle_product_uses_derivative_and_zero_pole_terms():
    ...
    J = BasisOperator("J_zhu_circle", conformal_weight=1)
    K = BasisOperator("K_zhu_circle", conformal_weight=1)
    Bosonic(J, K)
...
def test_generic_zhu_reducer_kills_circle_generators_mod_ov():
    J = BasisOperator("J_zhu_reduce", conformal_weight=1)
    K = BasisOperator("K_zhu_reduce", conformal_weight=1)
    Bosonic(J, K)
...
def test_zhu_space_exposes_reducer_style_api_and_multiply():
    J = BasisOperator("J_zhu_space", conformal_weight=1)
    K = BasisOperator("K_zhu_space", conformal_weight=1)
    Bosonic(J, K)
...
def test_zhu_space_generators_and_basis_are_fixed_weight():
    J = BasisOperator("J_zhu_generators", conformal_weight=1)
