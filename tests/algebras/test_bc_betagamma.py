...
class TestBCSystem:
    ...
    def test_bc_operators_declaration(self):
        lam_val = 2
        b = BasicOperator("b", conformal_weight=lam_val, fermionic=True)
        c = BasicOperator("c", conformal_weight=1 - lam_val, fermionic=True)
        Fermionic(b, c)
    ...
    def test_bc_ope(self):
        b = BasicOperator("b", conformal_weight=2, fermionic=True)
        c = BasicOperator("c", conformal_weight=-1, fermionic=True)
        Fermionic(b, c)
        OPE[b, c] = MakeOPE([One])
