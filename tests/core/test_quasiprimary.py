...
def _z3_rank_one_data():
    b = BasicOperator("b_z3_qp", fermionic=True, conformal_weight=Fraction(2))
    c = BasicOperator("c_z3_qp", fermionic=True, conformal_weight=Fraction(-1))
    beta = BasicOperator("beta_z3_qp", conformal_weight=Fraction(3, 2))
    gamma = BasicOperator("gamma_z3_qp", conformal_weight=Fraction(-1, 2))
...
def _z2_rank_one_data():
    b = BasicOperator("b_z2_qp", fermionic=True, conformal_weight=Fraction(3, 2))
    c = BasicOperator("c_z2_qp", fermionic=True, conformal_weight=Fraction(-1, 2))
    beta = BasicOperator("beta_z2_qp", conformal_weight=Fraction(1))
    gamma = BasicOperator("gamma_z2_qp", conformal_weight=Fraction(0))
...
def _z4_rank_one_data():
    p = 4
    b = BasicOperator("b_z4_qp", fermionic=True, conformal_weight=Fraction(p + 1, 2))
    c = BasicOperator("c_z4_qp", fermionic=True, conformal_weight=Fraction(1 - p, 2))
    beta = BasicOperator("beta_z4_qp", conformal_weight=Fraction(p, 2))
    gamma = BasicOperator("gamma_z4_qp", conformal_weight=Fraction(2 - p, 2))
